        ...
        >
          {(item: BannerItem) => (
            <div className="grid lg:grid-cols-3 grid-cols-1">
              ...
              <div className="flex flex-col justify-center items-center lg:ps-16 lg:pe-2 col-span-1">
                ...
                <div className="mt-12 flex gap-4 items-center justify-center w-full lg:justify-between">
                  <Link
