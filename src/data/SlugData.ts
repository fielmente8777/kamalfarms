...
export const SlugData: slugDataProps[] = [
    {
        ...
        bannerData: {
            images: ["/outside.jpeg", "/outside.jpeg",],
        ...
        experience: {
            ...
            arrImages: ["/outside.jpeg", "/outside.jpeg", "/outside.jpeg", "/outside.jpeg", "/outside.jpeg",],
            list: [
                "Enjoy privacy at the 6000 sq.ft. riverview villa",
                "The mansion provides room for upto 32 guests", "5 spacious yet cozy bedrooms for guests of all ages",
